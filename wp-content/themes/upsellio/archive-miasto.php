...
<style>
  ...
  .miasta-hero{padding:64px 0 36px;border-bottom:1px solid var(--border,#e2e8f0);background:var(--bg-soft,#f1f5f9)}
  ...
  .miasta-link{display:block;padding:14px 16px;border:1px solid #e2e8f0;border-radius:12px;color:#334155;text-decoration:none;background:#fff;transition:.18s ease}
  .miasta-link:hover{border-color:#0d9488;color:#0d9488;transform:translateY(-2px)}
