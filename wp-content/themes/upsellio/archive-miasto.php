...
?>
<style>
  .miasta-wrap{width:min(1180px,calc(100% - 48px));margin:0 auto;padding:56px 0}
  ...
  .miasta-grid{margin-top:28px;display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px 18px}
  ...
  @media(max-width:960px){.miasta-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}
  @media(max-width:760px){.miasta-wrap{width:min(1180px,calc(100% - 32px))}.miasta-grid{grid-template-columns:1fr}}
</style>
<main>
