...
<style>
  ...
  .offer-decision-card { padding: 18px; border: 1px solid var(--offer-border); border-radius: 20px; background: #fff; box-shadow: var(--offer-shadow-soft); transition: .2s ease; }
  ...
  .offer-icon { width: 48px; height: 48px; display: grid; place-items: center; margin-bottom: 22px; border-radius: 16px; background: var(--offer-green-soft); color: var(--offer-green-dark); font-weight: 900; font-size: 20px; }
  ...
  .offer-chooser-card { padding: 28px; border: 1px solid var(--offer-border); border-radius: 26px; background: #fff; box-shadow: var(--offer-shadow-soft); }
  ...
  .offer-steps { display: grid; grid-template-columns: repeat(2, 1fr); gap: 14px; }
  .offer-step { padding: 22px; border: 1px solid rgba(255, 255, 255, .12); border-radius: 20px; background: rgba(255, 255, 255, .06); }
  .offer-step b { display: inline-flex; align-items: center; justify-content: center; width: 32px; height: 32px; margin-bottom: 14px; border-radius: 50%; background: rgba(143, 240, 202, .14); color: #8ff0ca; font-family: var(--font-display); }
...
<main class="offer-page">
  ...
  <section class="offer-hero" id="start">
    <div class="wrap">
      ...
      <p class="offer-body">Każda z tych usług może działać niezależnie, ale najlepsze wyniki osiągasz, gdy tworzą jeden spójny system marketingowy. Zanim zaproponuję konkretne działania, przeprowadzam diagnozę: sprawdzam, gdzie realnie traci się potencjalnych klientów i który element poprawiony jako pierwszy przyniesie największy efekt.</p>
      ...
      <div class="offer-decision">
        <a href="#google-ads" class="offer-decision-card"><strong>Mam popyt w Google</strong><span>Klienci już szukają usługi lub produktu.</span></a>
        <a href="#meta-ads" class="offer-decision-card"><strong>Chcę budować popyt</strong><span>Potrzebuję dotrzeć do nowych odbiorców.</span></a>
        <a href="#strony-www" class="offer-decision-card"><strong>Strona nie konwertuje</strong><span>Mam ruch, ale za mało zapytań.</span></a>
      </div>
    </div>
  </section>
  ...
  <section class="offer-section offer-section-border" id="oferta">
    <div class="wrap">
      ...
      <div class="offer-grid">
        <article class="offer-card" id="google-ads">
          <div class="offer-icon">G</div>
        ...
        <article class="offer-card" id="meta-ads">
          <div class="offer-icon">M</div>
        ...
        <article class="offer-card" id="strony-www">
          <div class="offer-icon">W</div>
    ...
    <div class="wrap">
      <div class="offer-dark-box">
        ...
        <div class="offer-steps">
          <div class="offer-step"><b>1</b><strong>Analiza</strong><p>Sprawdzam stronę, obecne kampanie, ofertę, komunikat i ścieżkę klienta od pierwszego kontaktu do zapytania lub zakupu.</p></div>
          <div class="offer-step"><b>2</b><strong>Strategia</strong><p>Ustalam priorytety: Google Ads, Meta Ads, strona albo cała ścieżka. Określam cele, KPI i sposób mierzenia efektów.</p></div>
          <div class="offer-step"><b>3</b><strong>Wdrożenie</strong><p>Tworzę strukturę kampanii, komunikaty reklamowe, landing pages, CTA i elementy konwersji.</p></div>
          <div class="offer-step"><b>4</b><strong>Optymalizacja</strong><p>Regularnie analizuję jakość leadów, koszt pozyskania, konwersję strony i ROAS, a potem optymalizuję kampanie i stronę iteracyjnie.</p></div>
        </div>
      </div>
    </div>
  </section>
