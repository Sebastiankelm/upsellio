...
function upsellio_template_assets_slots()
{
    return [
        ...
        "home_hero_photo" => [
            "group" => "Strona główna",
            "label" => "Home - zdjęcie hero",
            "description" => "Główne zdjęcie w hero strony głównej. Zalecane pionowe ujęcie min. 1200x1500, WebP.",
            "fallback" => "Hero",
            "default_alt" => "Sebastian Kelm - konsultant marketingu B2B",
            "default_caption" => "Sebastian Kelm - Upsellio",
        ],
        "home_about_photo" => [
            "group" => "Strona główna",
            "label" => "Home - zdjęcie sekcji O mnie",
            "description" => "Zdjęcie sekcji O mnie na stronie głównej. Zalecane 1200x900, WebP.",
            "fallback" => "About",
            "default_alt" => "Sebastian Kelm podczas konsultacji marketingowej",
            "default_caption" => "Konsultacje marketingowe Upsellio",
        ],
        "home_badge_1" => [
            "group" => "Strona główna",
            "label" => "Home - badge hero 1",
            "description" => "Mała grafika w pierwszej badge przy zdjęciu hero. Zalecane 200x200, WebP.",
            "fallback" => "B1",
            "default_alt" => "Badge z osiągnięciem Upsellio",
            "default_caption" => "100+ projektów",
        ],
        "home_badge_2" => [
            "group" => "Strona główna",
            "label" => "Home - badge hero 2",
            "description" => "Mała grafika w drugiej badge przy zdjęciu hero. Zalecane 200x200, WebP.",
            "fallback" => "B2",
            "default_alt" => "Badge specjalizacji B2B",
            "default_caption" => "B2B specialist",
        ],
